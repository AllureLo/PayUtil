...
public class HttpUtil {
     ...
     * @return SSL上下文对象
     */
    public static SSLContext getSSLContext(String certPath, String certPass) throws Exception {
        KeyStore keyStore = KeyStore.getInstance("PKCS12");
        // 证书文件流
        ClassPathResource resource = new ClassPathResource(certPath);
        keyStore.load(resource.getInputStream(), certPass.toCharArray());
        // 相信自己的CA和所有自签名的证书
     ...
     * @return URI
     */
    private URI getUrl(String url, Map<String, String> params) throws URISyntaxException{
        // 创建访问的地址
     ...
     * @return HttpGet
     */
    private HttpGet doGet(String url, Map<String, String> headers, Map<String, String> params) throws URISyntaxException{
        // 创建访问的地址
     ...
     * @return HttpPost
     */
    private HttpPost doPost(String url, Map<String, String> headers, Map<String, String> params, String json, String contentType) throws URISyntaxException, UnsupportedEncodingException {
        // 创建httpPost
        HttpPost httpPost;
    ...
    public static class Builder {
         ...
         * @param certPass   SSL密码
         */
        public Builder getHttpClient(String certPath, String certPass) throws Exception{
         ...
         * @return HttpGet
         */
        public Builder doGet(String url) throws URISyntaxException, IOException {
         ...
         * @return HttpPost
         */
        public Builder doPost(String url) throws URISyntaxException, IOException {
         ...
         * @return
         */
        public Builder doHttp(String url, Https https) throws URISyntaxException, IOException {
            switch (https) {
                case POST:
                    return doPost(url);
                case GET:
         ...
         * @return
         */
        private Builder doHttp() throws IOException {
            //请求client
         ...
         * @return
         */
        public <T> Map<String, T> toMap() throws IOException {
        ...
        public <T> List<T> toList(Class<T> clazz) throws IOException {
            return GsonUtil.gsonToList(toJson(), clazz);
        }
         ...
         * @return
         */
        public <T> List<Map<String, T>> toListMap(Class<T> clazz) throws IOException {
            return GsonUtil.gsonToListMaps(toJson());
        }
    }
